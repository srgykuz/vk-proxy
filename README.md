...
Если устройство в условиях белого списка использует сторонний DNS-сервер, то убедитесь, что этот сервер доступен. Например, `8.8.8.8` (Google) и `1.1.1.1` (Cloudflare) могут быть заблокированы или работать нестабильно. Используйте DNS провайдера или любой другой доступный в условиях белого списка - например, `77.88.8.8` (Яндекс) или `62.76.76.62` (MSK-IX).
